...
define AESD_ASSIGNMENTS_INSTALL_TARGET_CMDS
	...
	$(INSTALL) -m 0755 $(@D)/file-transfer/test.txt $(TARGET_DIR)/usr/bin/
	$(INSTALL) -m 0755 $(@D)/file-transfer/test.sh $(TARGET_DIR)/usr/bin/
	$(INSTALL) -m 0755 $(@D)/test-led-app $(TARGET_DIR)/usr/bin/
endef
